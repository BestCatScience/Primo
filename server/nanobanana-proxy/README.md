...
- `com.bestcatscience.primo.nanobanana.monthly` の購読権利が有効か確認
...
- Node.js 20 以上
- App Store Connect で `com.bestcatscience.primo.nanobanana.monthly` を作成済み
...
{
  "image_base64": "...",
  "product_id": "com.bestcatscience.primo.nanobanana.monthly",
  "environment": "Sandbox"
}
```
