...
extension BrushRuntimeSettings {
    ...
    func withPhotoshopBrush(_ imported: ImportedPhotoshopBrush) -> BrushRuntimeSettings {
        BrushRuntimeSettings(
            ...
            smudgeEngineEnabled: imported.preset.smudgeEngineEnabled,
            smudgeMode: imported.preset.smudgeMode,
            smudgeLength: imported.preset.smudgeLength,
            colorRate: imported.preset.colorRate,
            loadPressureSensitivity: imported.preset.loadPressureSensitivity,
            paintAmountPressureBypass: imported.preset.paintAmountPressureBypass,
            paintDensityPressureBypass: imported.preset.paintDensityPressureBypass,
            colorStretchPressureBypass: imported.preset.colorStretchPressureBypass,
