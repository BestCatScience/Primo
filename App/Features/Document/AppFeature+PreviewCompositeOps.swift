...
typealias MetalStrokeExecutionMode = PrimoMetalStrokeExecutionMode
typealias MetalStrokeExecutionRequest = PrimoMetalStrokeExecutionRequest
typealias MetalStrokeExecutionResult = PrimoMetalStrokeExecutionResult

final class MetalDocumentProcessingClient {
    static let shared = MetalDocumentProcessingClient()

    private let backend = PrimoMetalDocumentProcessingClient.shared
    ...
    func executeStroke(_ request: MetalStrokeExecutionRequest) -> MetalStrokeExecutionResult? {
