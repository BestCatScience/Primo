...
extension PrimoRootFeature {
    struct CanvasToolStateCoordinator {
        func resolvedBrushSettings(for state: PrimoRootFeature.State) -> BrushRuntimeSettings {
        ...
        func previewStrokeStyle(for state: PrimoRootFeature.State) -> PreviewStrokeStyle {
        ...
        func resolvedPaperStyle(for state: PrimoRootFeature.State) -> CanvasPaperStyle {
