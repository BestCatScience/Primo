...
extension PaintDocumentSession {
    ...
    func presentation() -> PaintDocumentPresentation {
        ...
        let compositePixelData = documentGateway.queries.compositePixelData()
    ...
    func prewarmDrawingResources() {
        _ = documentGateway.queries.compositePixelData()
    }

    func compositePixelData() -> Data {
        documentGateway.queries.compositePixelData()
    }
