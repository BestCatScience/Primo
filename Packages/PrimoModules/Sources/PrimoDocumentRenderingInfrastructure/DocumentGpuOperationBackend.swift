...
struct DocumentGpuOperationBackend: Sendable {
    ...
    var expandedSelectionMask: @Sendable (Data, Int, Int, Int, Int, Int, Int) -> [UInt8]?
    ...
    var transformedSelectionMask: @Sendable ([UInt8], Int, Int, CGSize, CGFloat, CGFloat, Double, CGPoint, TransformQuad, TransformQuad, Bool) -> [UInt8]?
    var transformedLayerPixelData: @Sendable (Data, Int, Int, [UInt8]?, CGSize, CGFloat, CGFloat, Double, CGPoint, TransformQuad, TransformQuad, Bool) -> Data?
