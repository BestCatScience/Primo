...
struct GpuSideEffectIsolationArchitectureTests {
    ...
    func appWorkflowValidationReturnsEditableLayerCapability() throws {
        ...
        #expect(!validation.contains("ValidatedDocumentLayerMutationCommand"))
        #expect(layerEditAuthorization.contains("let command: DocumentMutationCommand"))
        ...
        #expect(adapters.contains("command.editableLayerIndex"))
