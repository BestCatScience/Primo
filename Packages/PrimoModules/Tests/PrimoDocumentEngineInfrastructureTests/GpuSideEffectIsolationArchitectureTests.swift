...
struct GpuSideEffectIsolationArchitectureTests {
    ...
    func documentDTOsExposeInvariantValueObjects() throws {
        ...
        #expect(textLayer.contains("public var textContent: TextContent"))
        #expect(textLayer.contains("public var fontSizeValue: PositiveFiniteDouble"))
        #expect(textLayer.contains("public var scaleValue: PositiveFiniteDouble"))
        #expect(textLayer.contains("public var color: CanvasColor"))
        #expect(textLayer.contains("public var rotationDegreesValue: FiniteDouble"))
